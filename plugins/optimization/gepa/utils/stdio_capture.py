...
class ThreadLocalStreamCapture:
    ...
    def __getattr__(self, name: str) -> Any:  # noqa: ANN401 - transparent stream proxy preserves implementation-specific attributes
...
class StreamCaptureManager:
    ...
    def acquire(self) -> tuple[ThreadLocalStreamCapture, ThreadLocalStreamCapture]:
        ...
        with self._lock:
            ...
            self._refcount += 1
            assert (
                self._stdout_capturer is not None and self._stderr_capturer is not None
            )
